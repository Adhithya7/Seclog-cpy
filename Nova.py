...
token_data_f = open(template_path + 'tokennova.pickle','rb')
tokens = pickle.load(token_data_f)
token_data_f.close()

log_data_f = open(template_path + 'lognova.pickle','rb')
log_data = pickle.load(log_data_f)
log_data_f.close()

feature_sets_f = open(template_path + 'novafs.pickle','rb')
feature_sets = pickle.load(feature_sets_f)
feature_sets_f.close()

classifier_f = open(template_path + "nbnova.pickle","rb")
classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(template_path + "mnbnova.pickle","rb")
MultinomialNB_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(template_path + "bnbnova.pickle","rb")
BernoulliNB_classifier = pickle.load(classifier_f)
classifier_f.close()
 
classifier_f = open(template_path + "sgdnova.pickle","rb")
SGDClassifier_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(template_path + "lsvcnova.pickle","rb")
