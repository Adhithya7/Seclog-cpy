...
for i in range(1,len(hostl)):
    ...
    for logfile in glanlog:
        s= requests.Session()
        link = 'https://192.168.0.200:8080/glance'
        r = s.get(link,host,'glance',logfile)
        g = r.text
        ...
        output = open(home_path + 'glan_check.txt','w+')
